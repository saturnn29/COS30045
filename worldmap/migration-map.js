function init() {
    ...
    function visualizeCountry(countryCode, year) {
        ...
        d3.csv(dataUrl).then(function(data) {
            ...
            if (year == '2016') {
                ...
                markerColor = currentYearTotal === 0 ? 'gray' : (currentYearTotal > prevYearTotal ? 'green' : 'orange');
            } else if (currentYearTotal === prevYearTotal) {
                markerColor = 'gray'; // Set markerColor to gray for the later year if no change
            } else {
    ...
    function calculateRatio(currentYearTotal, prevYearTotal, year) {
        ...
        if (year == '2016') {
            ...
            return `<p>The total arrivals for the year ${previousYear} and ${currentYear} are the same.</p>`;
        } else {
            ...
            return ratio > 1
            ? `<p>The total arrivals for the year ${currentYear} are ${formattedPercentage}% higher than the previous year.</p>`
            : `<p>The total arrivals for the year ${currentYear} are ${formattedPercentage}% lower than the previous year.</p>`;
        }
    }
